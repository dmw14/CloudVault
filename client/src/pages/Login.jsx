...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-surface-100 via-white to-primary-100 dark:from-surface-950 dark:via-surface-900 dark:to-primary-900">
      ...
      <div className="pointer-events-none absolute -top-24 -left-16 h-72 w-72 rounded-full bg-primary-200/60 blur-3xl dark:bg-primary-500/20" />
      <div className="pointer-events-none absolute -bottom-28 -right-20 h-80 w-80 rounded-full bg-sky-200/60 blur-3xl dark:bg-primary-700/20" />
      <div className="pointer-events-none absolute top-1/2 left-8 h-28 w-28 -translate-y-1/2 rounded-3xl rotate-12 border border-primary-200/60 bg-white/60 backdrop-blur-sm dark:border-primary-400/20 dark:bg-surface-900/40" />
      <div className="pointer-events-none absolute top-24 right-12 h-20 w-20 -rotate-6 rounded-2xl border border-primary-200/60 bg-white/70 backdrop-blur-sm dark:border-primary-400/20 dark:bg-surface-900/40" />
      ...
      <div className="relative z-10 flex min-h-screen w-full items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl border border-surface-200/80 bg-white/95 p-8 sm:p-10 shadow-2xl shadow-surface-900/10 backdrop-blur dark:border-surface-700/60 dark:bg-surface-900/90 dark:shadow-black/30">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="w-full min-h-12 rounded-xl px-5 py-3.5 text-sm font-bold text-white tracking-wide
        ...
        <p className="mt-6 text-center text-sm text-surface-600 dark:text-surface-400">
          ...
          <Link to="/signup" className="font-bold text-primary-600 hover:underline transition-colors dark:text-primary-400">
            Sign up
          </Link>
        </p>
        </motion.div>
